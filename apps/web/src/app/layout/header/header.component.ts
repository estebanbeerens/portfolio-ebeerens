...
import { LanguageMenu, NavItem, Sidenav, ThemeToggle } from '@portfolio-ebeerens/ui';
...
@Component({
  selector: 'web-header',
  imports: [RouterLink, RouterLinkActive, LanguageMenu, ThemeToggle, Sidenav, NavItem, LucideDynamicIcon],
