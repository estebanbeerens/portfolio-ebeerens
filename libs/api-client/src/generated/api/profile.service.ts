...
// @ts-ignore
import { PublicPortfolioDto } from '../model/publicPortfolioDto';
// @ts-ignore
...
export class ProfileService extends BaseService {
  ...
  public profileControllerGetPublicPortfolio(
    ...
    let localVarPath = `/api/profile/public-portfolio`;
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<PublicPortfolioDto>('get', `${basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      ...(withCredentials ? { withCredentials } : {}),
      headers: localVarHeaders,
