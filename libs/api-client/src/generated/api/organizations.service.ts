...
export class OrganizationsService extends BaseService {
  ...
  public organizationsControllerCreate(
    ...
    if (createOrganizationDto === null || createOrganizationDto === undefined) {
      throw new Error(
        'Required parameter createOrganizationDto was null or undefined when calling organizationsControllerCreate.'
      );
    }
   ...
   * @param options additional options
   */
  public organizationsControllerRemove(
    id: string,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public organizationsControllerUpdate(
    ...
    if (updateOrganizationDto === null || updateOrganizationDto === undefined) {
      throw new Error(
        'Required parameter updateOrganizationDto was null or undefined when calling organizationsControllerUpdate.'
      );
    }
